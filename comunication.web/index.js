...
const createTweet = (t)=>{
    ...
    tweetTrash.onclick = ()=>{
        ...
        const tweetsString = localStorage.getItem("tutorial2")
        ...
        localStorage.setItem("tutorial2", JSON.stringify(newTweets))
    }
...
const storeTweet = (t)=>{
    ...
    if(tweetsString){
        ...
        localStorage.setItem("tutorial2",JSON.stringify([t]))
